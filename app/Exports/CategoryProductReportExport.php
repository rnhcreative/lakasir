...
class CategoryProductReportExport implements
    FromArray, WithHeadings, WithCustomStartCell, WithEvents, ShouldAutoSize
{
    ...
    public function __construct(
        public CategoryProductReportService $categoryProductReportService,
        public array $data)
    {
        $this->results = $this->categoryProductReportService->generate($this->data);
    }
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($header, $footer) {
                ...
                /** Header Row */
                $sheet->setCellValue('A1', 'Laporan Kategori Produk');
